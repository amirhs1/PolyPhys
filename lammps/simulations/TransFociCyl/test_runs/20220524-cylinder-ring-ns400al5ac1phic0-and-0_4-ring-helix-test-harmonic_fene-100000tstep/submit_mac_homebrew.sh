...
#SBATCH --time=00-15:00                	# Total time needed for this job. --time (DD-HH:MM) or -t 0-01:00;  Check the manual of sbatch
...
${lmp_exec} -log log.minimize_initial_config < ${lmp_input} > ${lmp_output}
