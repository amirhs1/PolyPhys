...
#SBATCH --nodes=1							# Using a node of 32 cpus together; it is more convenience for the Slurm.
#SBATCH --ntasks-per-node=32 				# number of mpi tasks (cpus); for a serial job, it is the default; 1.
