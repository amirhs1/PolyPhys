#!/bin/bash
# Generated on date 20240809
# ns lcube ac nc randseed_group dt b_dump a_dump al nl ml
P[${#P[@]}]="400	45	2	17404	14000	0.005	2000	5000	4	5	64"
P[${#P[@]}]="400	45	2	26106	14010	0.005	2000	5000	4	5	64"
P[${#P[@]}]="400	45	2	34808	14020	0.005	2000	5000	4	5	64"
P[${#P[@]}]="400	45	2	39159	14030	0.005	2000	5000	4	5	64"
P[${#P[@]}]="400	45	2	43509	14040	0.005	2000	5000	4	5	64"
P[${#P[@]}]="400	45	2	47860	14050	0.005	2000	5000	4	5	64"
P[${#P[@]}]="400	45	2	52211	14060	0.005	2000	5000	4	5	64"
P[${#P[@]}]="400	45	2	56562	14070	0.005	2000	5000	4	5	64"
P[${#P[@]}]="400	45	2	60913	14080	0.005	2000	5000	4	5	64"
P[${#P[@]}]="400	45	2	65264	14090	0.005	2000	5000	4	5	64"
P[${#P[@]}]="400	45	2	69615	14100	0.005	2000	5000	4	5	64"
