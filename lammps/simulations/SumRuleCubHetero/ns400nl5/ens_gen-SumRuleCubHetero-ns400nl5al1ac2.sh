#!/bin/bash
# Generated on date 20240725
# ns lcube ac nc randseed_group dt b_dump a_dump al nl ml
P[${#P[@]}]="400	45	2	17404	11000	0.005	2000	5000	1	5	216"
P[${#P[@]}]="400	45	2	26106	11010	0.005	2000	5000	1	5	216"
P[${#P[@]}]="400	45	2	34808	11020	0.005	2000	5000	1	5	216"
P[${#P[@]}]="400	45	2	39159	11030	0.005	2000	5000	1	5	216"
P[${#P[@]}]="400	45	2	43509	11040	0.005	2000	5000	1	5	216"
P[${#P[@]}]="400	45	2	47860	11050	0.005	2000	5000	1	5	216"
P[${#P[@]}]="400	45	2	52211	11060	0.005	2000	5000	1	5	216"
P[${#P[@]}]="400	45	2	56562	11070	0.005	2000	5000	1	5	216"
P[${#P[@]}]="400	45	2	60913	11080	0.005	2000	5000	1	5	216"
P[${#P[@]}]="400	45	2	65264	11090	0.005	2000	5000	1	5	216"
P[${#P[@]}]="400	45	2	69615	11100	0.005	2000	5000	1	5	216"
