...
P[${#P[@]}]="1000	5.0	8.0	308.5	1.0	20824	10010	0.005	1000	5000"
P[${#P[@]}]="1000	5.0	8.0	308.5	1.0	31236	10020	0.005	1000	5000"
P[${#P[@]}]="1000	5.0	8.0	308.5	1.0	41648	10030	0.005	1000	5000"
P[${#P[@]}]="1000	5.0	8.0	308.5	1.0	46854	10040	0.005	1000	5000"
P[${#P[@]}]="1000	5.0	8.0	308.5	1.0	52060	10050	0.005	1000	5000"
P[${#P[@]}]="1000	5.0	8.0	308.5	1.0	57266	10060	0.005	1000	5000"
P[${#P[@]}]="1000	5.0	8.0	308.5	1.0	62472	10070	0.005	1000	5000"
P[${#P[@]}]="1000	5.0	8.0	308.5	1.0	67678	10080	0.005	1000	5000"
P[${#P[@]}]="1000	5.0	8.0	308.5	1.0	72884	10090	0.005	1000	5000"
P[${#P[@]}]="1000	5.0	8.0	308.5	1.0	78090	10100	0.005	1000	5000"
P[${#P[@]}]="1000	5.0	8.0	308.5	1.0	83295	10110	0.005	1000	5000"
...
# The command I should use:
		...
		if [ $((${n_crowd}+${N})) -le 25000 ]; then
			...
			cp cylinder_v7_ac_larger_cpu8.lmp input.lmp # processors 2 2 *
		fi
