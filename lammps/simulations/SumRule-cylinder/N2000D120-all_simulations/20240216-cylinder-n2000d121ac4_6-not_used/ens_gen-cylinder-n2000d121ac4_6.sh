...
# N2000epsilon5.0r60.5lz144sig4.0nc0dt0.01bdump10000adump20000ens1.bug

#			 N		epsilon1	r		lz		sig2	n_crowd		randseed_group	run_dt 	bug_dump 	all_dump
P[${#P[@]}]="2000	5.0			60.5	144	4.0		0 			7000			0.005	10000		20000"
P[${#P[@]}]="2000	5.0			60.5	144	4.0		9083 		7010			0.005	10000		20000"
P[${#P[@]}]="2000	5.0			60.5	144	4.0		13624 		7020			0.005	10000		20000"
P[${#P[@]}]="2000	5.0			60.5	144	4.0		18166 		7030			0.005	10000		20000"
P[${#P[@]}]="2000	5.0			60.5	144	4.0		20436 		7040			0.005	10000		20000"
P[${#P[@]}]="2000	5.0			60.5	144	4.0		22707 		7050			0.005	10000		20000"
P[${#P[@]}]="2000	5.0			60.5	144	4.0		24978 		7060			0.005	10000		20000"
P[${#P[@]}]="2000	5.0			60.5	144	4.0		27248 		7070			0.005	10000		20000"
P[${#P[@]}]="2000	5.0			60.5	144	4.0		29519		7080			0.005	10000		20000"
P[${#P[@]}]="2000	5.0			60.5	144	4.0		31790 		7090			0.005	10000		20000"
P[${#P[@]}]="2000	5.0			60.5	144	4.0		34061 		7100			0.005	10000		20000"
P[${#P[@]}]="2000	5.0			60.5	144	4.0		36331 		7110			0.005	10000		20000"

P[${#P[@]}]="2000	5.0			60.5	144	6.0		2599 		7120			0.005	10000		20000"
P[${#P[@]}]="2000	5.0			60.5	144	6.0		3899 		7130			0.005	10000		20000"
P[${#P[@]}]="2000	5.0			60.5	144	6.0		5198 		7140			0.005	10000		20000"
P[${#P[@]}]="2000	5.0			60.5	144	6.0		5848 		7150			0.005	10000		20000"
P[${#P[@]}]="2000	5.0			60.5	144	6.0		6498 		7160			0.005	10000		20000"
P[${#P[@]}]="2000	5.0			60.5	144	6.0		7148 		7170			0.005	10000		20000"
P[${#P[@]}]="2000	5.0			60.5	144	6.0		7798 		7180			0.005	10000		20000"
P[${#P[@]}]="2000	5.0			60.5	144	6.0		8447 		7190			0.005	10000		20000"
P[${#P[@]}]="2000	5.0			60.5	144	6.0		9097 		7200			0.005	10000		20000"
P[${#P[@]}]="2000	5.0			60.5	144	6.0		9747 		7210			0.005	10000		20000"
P[${#P[@]}]="2000	5.0			60.5	144	6.0		10397 		7220			0.005	10000		20000"
