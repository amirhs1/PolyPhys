#!/bin/bash
# Here, we run a single chain in a criwder-free confinement, run the simulation
# until the chain reach eequilbirum and then use the data file written by
# LAMMPS as the input for the main simulation with crowders.
...
P[${#P[@]}]="2000	5.0			30.5	233.5	4.0		0 			100				0.01	5000		10000"
