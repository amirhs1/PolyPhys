#!/bin/bash
#			n_small  l  a_crowd n_crowd     randseed    run_dt      b_dump
#			a_dump  a_large n_large m_large
P[${#P[@]}]="400	48		1		0			23000		0.005		2000	5000	1 		5		1"
P[${#P[@]}]="400	45		1		139229		23000		0.005		2000	5000	1 		5		1"
P[${#P[@]}]="400	42		1		169798		23000		0.005		2000	5000	1 		5		1"
P[${#P[@]}]="400	42		1		226397		23030		0.005		2000	5000	1 		5		1"
P[${#P[@]}]="400	36		1		160392		23040		0.005		2000	5000	1 		5		1"
P[${#P[@]}]="400	36		1		178213		23050		0.005		2000	5000	1 		5		1"
P[${#P[@]}]="400	36		1		196035		23060		0.005		2000	5000	1 		5		1"
P[${#P[@]}]="400	36		1		213856		23070		0.005		2000	5000	1 		5		1"
P[${#P[@]}]="400	30		1		134073		23080		0.005		2000	5000	1 		5		1"
P[${#P[@]}]="400	30		1		144386		23090		0.005		2000	5000	1 		5		1"
P[${#P[@]}]="400	30		1		154699		23100		0.005		2000	5000	1 		5		1"
P[${#P[@]}]="400	30		1		165012		23110		0.005		2000	5000	1 		5		1"
...
P[${#P[@]}]="400	37.5	1		181288		22040		0.005		2000	5000	3 		5		27"
P[${#P[@]}]="400	37.5	1		201431		22050		0.005		2000	5000	3 		5		27"
P[${#P[@]}]="400	37.5	1		221574		22060		0.005		2000	5000	3 		5		27"
P[${#P[@]}]="400	37.5	1		241717		22070		0.005		2000	5000	3 		5		27"
P[${#P[@]}]="400	30		1		134073		22080		0.005		2000	5000	3 		5		27"
P[${#P[@]}]="400	30		1		144386		22090		0.005		2000	5000	3 		5		27"
P[${#P[@]}]="400	30		1		154699		22100		0.005		2000	5000	3 		5		27"
P[${#P[@]}]="400	30		1		165012		22110		0.005		2000	5000	3 		5		27"
...
P[${#P[@]}]="400	42.5	1		0			24000		0.005		2000	5000	4 		5		64"
P[${#P[@]}]="400	42.5	1		117290		24010		0.005		2000	5000	4 		5		64"
P[${#P[@]}]="400	42.5	1		175934		24020		0.005		2000	5000	4 		5		64"
P[${#P[@]}]="400	39		1		181266		24030		0.005		2000	5000	4 		5		64"
P[${#P[@]}]="400	39		1		203924		24040		0.005		2000	5000	4 		5		64"
P[${#P[@]}]="400	39		1		226582		24050		0.005		2000	5000	4 		5		64"
P[${#P[@]}]="400	37.5	1		221574		24060		0.005		2000	5000	4 		5		64"
P[${#P[@]}]="400	34.5	1		188222		24070		0.005		2000	5000	4 		5		64"
...
#ens='1' # Here, we define a global variable called "ens" which is the total
#ensemble we use in our simulation.

# Note: ens='1 2 3 4' used for a_large=4,6.
