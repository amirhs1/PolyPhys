...
#SBATCH --time=00-12:00                	# Total time needed for this job. --time (DD-HH:MM) or -t 0-01:00;  Check the manual of sbatch
...
module --force purge
module load StdEnv/2023  intel/2023.2.1  openmpi/4.1.5 lammps-local/20230802
