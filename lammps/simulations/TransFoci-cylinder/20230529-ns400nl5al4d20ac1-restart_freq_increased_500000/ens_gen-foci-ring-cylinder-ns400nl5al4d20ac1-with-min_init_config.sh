...
P[${#P[@]}]="400	5			5			10.5	72		1		0			17000		0.005	2000	5000	4 		5		64"
P[${#P[@]}]="400	5			5			10.5	72		1		8640		17010		0.005	2000	5000	4 		5		64"
P[${#P[@]}]="400	5			5			10.5	72		1		12960		17020		0.005	2000	5000	4 		5		64"
P[${#P[@]}]="400	5			5			10.5	72		1		17280		17030		0.005	2000	5000	4 		5		64"
P[${#P[@]}]="400	5			5			10.5	61.5	1		16605		17040		0.005	2000	5000	4 		5		64"
P[${#P[@]}]="400	5			5			10.5	61.5	1		18450		17050		0.005	2000	5000	4 		5		64"
P[${#P[@]}]="400	5			5			10.5	61.5	1		20295		17060		0.005	2000	5000	4 		5		64"
P[${#P[@]}]="400	5			5			10.5	61.5	1		22140		17070		0.005	2000	5000	4 		5		64"
P[${#P[@]}]="400	5			5			10.5	45		1		17550		17080		0.005	2000	5000	4 		5		64"
P[${#P[@]}]="400	5			5			10.5	45		1		18900		17090		0.005	2000	5000	4 		5		64"
P[${#P[@]}]="400	5			5			10.5	45		1		20250		17100		0.005	2000	5000	4 		5		64"
P[${#P[@]}]="400	5			5			10.5	45		1		21600		17110		0.005	2000	5000	4 		5		64"
