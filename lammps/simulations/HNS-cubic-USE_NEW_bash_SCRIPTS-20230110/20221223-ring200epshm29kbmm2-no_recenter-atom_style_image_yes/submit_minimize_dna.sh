...
#SBATCH --time=00-00:20                	# Total time needed for this job. --time (DD-HH:MM) or -t 0-01:00;  Check the manual of sbatch
...
lmp_exec=lmp
lmp_input="minimize_dna.lmp"
lmp_output="minimize_dna-output.txt"

srun ${lmp_exec} -log log.minimize_dna < ${lmp_input} > ${lmp_output}
