...
P[${#P[@]}]="2000	5.0	13.0	431		1.0	80813	1770	0.005	1000	5000"
P[${#P[@]}]="2000	5.0	13.0	431		1.0	121219	1780	0.005	1000	5000"
...
# The command I should use:
		...
		elif [ $((${n_crowd}+${N})) -le 50000 ]; then
			cp cylinder_v7_ac_larger_cpu8.lmp input.lmp # processors 2 2 *
		elif [ $((${n_crowd}+${N})) -le 100000 ]; then
			cp cylinder_v7_ac_larger_cpu16.lmp input.lmp # processors 2 2 *
		else
			cp cylinder_v7_ac_larger_cpu32.lmp input.lmp # processors 2 2 *
		fi
