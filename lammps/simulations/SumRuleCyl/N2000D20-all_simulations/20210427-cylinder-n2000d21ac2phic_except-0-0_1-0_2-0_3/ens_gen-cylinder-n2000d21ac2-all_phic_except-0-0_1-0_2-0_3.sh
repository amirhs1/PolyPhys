...
P[${#P[@]}]="2000	5.0	10.5	504		2.0	11340	3090	0.005	1000	5000"
P[${#P[@]}]="2000	5.0	10.5	504		2.0	17010	3100	0.005	1000	5000"
P[${#P[@]}]="2000	5.0	10.5	504		2.0	18900	3110	0.005	1000	5000"
P[${#P[@]}]="2000	5.0	10.5	504		2.0	20790	3120	0.005	1000	5000"
P[${#P[@]}]="2000	5.0	10.5	504		2.0	24570	3130	0.005	1000	5000"
P[${#P[@]}]="2000	5.0	10.5	504		2.0	26460	3140	0.005	1000	5000"
P[${#P[@]}]="2000	5.0	10.5	504		2.0	28350	3150	0.005	1000	5000"
P[${#P[@]}]="2000	5.0	10.5	504		2.0	30240	3160	0.005	1000	5000"
...
# The command I should use:
		...
		if [ $((${n_crowd}+${N})) -ne 0 ]; then
			if [ $((${n_crowd}+${N})) -le 5000 ]; then
				...
				cp submit_cpu8_gt25000_le45000.sh submit.sh && mv submit.sh ${dirname}
			fi
		else
