...
#SBATCH --time=00-04:00                	# Total time needed for this job. --time (DD-HH:MM) or -t 0-01:00;  Check the manual of sbatch
...
lmp_exec=lmp
lmp_input="system_minimize.lmp"
lmp_output="system_minimize-output.txt"

srun ${lmp_exec} -log log.system_minimize < ${lmp_input} > ${lmp_output}
