...
# N2000epsilon5.0r120.5lz147sig4.0nc0dt0.01bdump10000adump10000ens1.bug

#			 N		epsilon1	r		lz		sig2	n_crowd		randseed_group	run_dt 	bug_dump 	all_dump
P[${#P[@]}]="2000	5.0			120.5	147	4.0		0 			8000			0.005	5000		10000"
P[${#P[@]}]="2000	5.0			120.5	147	4.0		38378 		8010			0.005	5000		10000"
P[${#P[@]}]="2000	5.0			120.5	147	4.0		57567 		8020			0.005	5000		10000"
P[${#P[@]}]="2000	5.0			120.5	147	4.0		76756 		8030			0.005	5000		10000"
P[${#P[@]}]="2000	5.0			120.5	147	4.0		86351 		8040			0.005	5000		10000"
P[${#P[@]}]="2000	5.0			120.5	147	4.0		95945 		8050			0.005	5000		10000"
P[${#P[@]}]="2000	5.0			120.5	147	4.0		105540 		8060			0.005	5000		10000"
P[${#P[@]}]="2000	5.0			120.5	147	4.0		115134 		8070			0.005	5000		10000"
P[${#P[@]}]="2000	5.0			120.5	147	4.0		124729		7880			0.005	5000		10000"
P[${#P[@]}]="2000	5.0			120.5	147	4.0		134323 		8090			0.005	5000		10000"
P[${#P[@]}]="2000	5.0			120.5	147	4.0		143918 		8100			0.005	5000		10000"
P[${#P[@]}]="2000	5.0			120.5	147	4.0		153512 		8110			0.005	5000		10000"

P[${#P[@]}]="2000	5.0			120.5	147	6.0		11179 		8120			0.005	5000		10000"
P[${#P[@]}]="2000	5.0			120.5	147	6.0		16769 		8130			0.005	5000		10000"
P[${#P[@]}]="2000	5.0			120.5	147	6.0		22359 		8140			0.005	5000		10000"
P[${#P[@]}]="2000	5.0			120.5	147	6.0		25154 		8150			0.005	5000		10000"
P[${#P[@]}]="2000	5.0			120.5	147	6.0		27948 		8160			0.005	5000		10000"
P[${#P[@]}]="2000	5.0			120.5	147	6.0		30742 		8170			0.005	5000		10000"
P[${#P[@]}]="2000	5.0			120.5	147	6.0		33538 		8180			0.005	5000		10000"
P[${#P[@]}]="2000	5.0			120.5	147	6.0		36333 		8190			0.005	5000		10000"
P[${#P[@]}]="2000	5.0			120.5	147	6.0		39128 		8200			0.005	5000		10000"
P[${#P[@]}]="2000	5.0			120.5	147	6.0		41923 		8210			0.005	5000		10000"
P[${#P[@]}]="2000	5.0			120.5	147	6.0		44717 		8220			0.005	5000		10000"

P[${#P[@]}]="2000	5.0			120.5	147	8.0		4636 		8230			0.005	5000		10000"
P[${#P[@]}]="2000	5.0			120.5	147	8.0		6954 		8240			0.005	5000		10000"
P[${#P[@]}]="2000	5.0			120.5	147	8.0		9272		8250			0.005	5000		10000"
P[${#P[@]}]="2000	5.0			120.5	147	8.0		10431 		8260			0.005	5000		10000"
P[${#P[@]}]="2000	5.0			120.5	147	8.0		11590 		8270			0.005	5000		10000"
P[${#P[@]}]="2000	5.0			120.5	147	8.0		12749 		8280			0.005	5000		10000"
P[${#P[@]}]="2000	5.0			120.5	147	8.0		13908 		8290			0.005	5000		10000"
P[${#P[@]}]="2000	5.0			120.5	147	8.0		15067 		8300			0.005	5000		10000"
P[${#P[@]}]="2000	5.0			120.5	147	8.0		16226 		8310			0.005	5000		10000"
P[${#P[@]}]="2000	5.0			120.5	147	8.0		17385 		8320			0.005	5000		10000"
P[${#P[@]}]="2000	5.0			120.5	147	8.0		18544 		8330			0.005	5000		10000"
