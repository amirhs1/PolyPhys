...
PROJECT_DETAILS = {
    ...
    'HnsCub': {
        ...
        'edge_directions': ['x', 'y', 'z'],
        'space_hierarchy': 'N*',
        'attributes': ['space', 'ensemble_long', 'ensemble', 'nmon', 'bend_mm',
                       'eps_hc', 'nhns', 'dcrowd', 'phi_c_bulk',
                       'rho_hns_bulk'],
        'time_varying_props': ['asphericityTMon', 'gyrTMon', 'shapeTMon'],
        'equil_measures': [np.mean, np.var, measurer.sem],
...
TITLE_STYLES = {
    ...
    'HnsCub': {
        'title': lambda s: fr"$N={s.nmon}, N_{{h}}={s.nhns}, \varepsilon_{{hc}}={s.eps_hc}, a_c={s.dcrowd}$",
        'short': lambda s: fr"$N_{{h}}={s.nhns}, \varepsilon_{{hc}}={s.eps_hc}",
        'universe': lambda s: fr"$N={s.nmon}$"
    },
    'HnsCyl': {
        'title': lambda s: fr"$N={s.nmon}, D={s.dcyl}, N_{{h}}={s.nhns}, a_c={s.dcrowd}$",
        'short': lambda s: fr"$N_{{h}}={s.nhns}, a_c={s.dcrowd}$",
        'universe': lambda s: fr"$N={s.nmon}, D={s.dcyl}$"
    }
}
...
ATTRIBUTE_LABELS = {
    ...
    'transSizeMon-norm-dcyl':
        r'$\langle L_{\perp}\rangle/D$',
    'asphericityMon-norm':
        r'$\langle \Delta\rangle/\langle \Delta_{0}\rangle$',
    'shapeMon-norm': r'$\langle S\rangle/\langle S_{0}\rangle$',
    # norm simple
    'rfloryMon-norm-simple': r'$ R_F/ R_{F,0}$',
    'gyrMon-norm-simple': r'$ R_g/ R_{g,0}$',
    'fsdMon-norm-simple': r'$ L/ L_{0}$',
    'transSizeMon-norm-simple':
        r'$ L_{\perp}/ L_{\perp,0}$',
    'transSizeMon-norm-dcyl-simple':
        r'$ L_{\perp}/D$',
    'asphericityMon-norm-simple':
        r'$ \Delta/ \Delta_{0}$',
    'shapeMon-norm-simple': r'$ S/ S_{0}$',
    'gyrMon-mean-simple': r'$ R_g$',
    'asphericityMon-mean-simple': r'$ \Delta$',
    'shapeMon-mean-simple': r'$ S$',
    # others
    'rPhi': r'$\phi(r)$',
    'zPhi': r'$\phi(|z|)$',
    'rRho': r'$\rho(r)$',
    ...
    'bondsHistFoci-bin_center-average-simple': r'$x_{drt}$',
    ...
    'clustersHistFoci-bin_center-average-simple': r'$x_{cls}$',
    ...
    'pairDistRdfGenDistAvg-short_name': r'$f$',
    ...
    'bin_center': '$r/a_m$',
    'bin_center-norm-dmon_large-r': '${{r}}/{{a_M}}$',
    'bin_center-norm-dmon_large_old-r': '${{r}}/{{a_l}}$',
    'bin_center-norm': '${{r}}/{{r_{max}}}$',
    'bin_center-norm-r': '${{r}}/{{r_{max}}}$',
    'bin_center-norm-corrected-r-max': '${{r}}/{{r_{max}}}$',
    'bin_center-norm-corrected-r': '${{r}}/{{D}}$',
    'bin_center-r': '$r$',
    ...
    'bin_center-norm-dmon_large-r-cub': '${{r}}/{{a_M}}$',
    'bin_center-norm-dmon_large_old-r-cub': '${{r}}/{{a_l}}$',
    ...
    'bin_center-z': '$z$',
    'bin_center-norm-z': '${{2|z|}}/{{Z}}$',
    'bin_center-norm-corrected-z': '${{2|z|}}/{{Z}}$',
    'bin_center-norm-dmon_large-z': '${{z}}/{{a_M}}$',
    'bin_center-norm-dmon_large-old-z': '${{z}}/{{a_l}}$',
    ...
    'nmon': '$N$',
    'nhns': r'$N_{{h}}$',
    'c_hns_bulk': r'$c_{h} (\mu M)$',
    'c_hns_bulk-old': r'$[HNS] (\mu M)$',
    'phi_c_rescaled': r'$\frac{a_m\phi_c}{a_c}$',
    'confinement_rate': r'$\kappa$',
    'confinement_rate_full_r': r'$\kappa=\frac{a_c}{D-a_c}$',
    'confinement_rate_full': r'$\kappa=\frac{D-a_c}{a_c}$',
    'dep_energy_max':
    ...
    'nBoundHnsCore-mean': r'$\langle N_{h}^{bound}\rangle$',
    'nCisMon-mean': r'$\langle N^{cis}\rangle$',
    'nTransMon-mean': r'$\langle N^{trans}\rangle$',
    'bondLengthMon-mean': r'$\langle l \rangle$',
    'nBoundHnsPatch-norm':
        r'$\frac{{\langle N_{h}^{bound}\rangle}}{{2N_h}}$',
    'nFreeHnsPatch-norm':
        r'$\frac{{\langle N_{h}^{free}\rangle}}{{2N_h}}$',
    'nHnsPatch-total':
        r'$\frac{{\langle N_{h}^{total}\rangle}}{{2N_h}}$',
    'nEngagedHnsPatch-norm':
        r'$\frac{{\langle N_{h}^{engaged}\rangle}}{{2N_h}}$',
    'nFreeHnsCore-norm':
        r'$\frac{{\langle N_{h}^{free}\rangle}}{{N_h}}$',
    'nBridgeHnsCore-norm-old':
        r'$\frac{{\langle N_{h}^{bridge}\rangle}}{{N_h}}$',
    'nDangleHnsCore-norm-old':
        r'$\frac{{\langle N_{h}^{dangle}\rangle}}{{N_h}}$',
    'nHnsCore-total':
        r'$\frac{{\langle N_{h}^{total}\rangle}}{{N_h}}$',
    'nBoundHnsCore-norm-old':
        r'$\frac{{\langle N_{h}^{bound}\rangle}}{{N_h}}$',
    'nCisHnsCore-norm-old':
        r'$\frac{{\langle N_{h}^{cis}\rangle}}{{N_h}}$',
    'nTransHnsCore-norm-old':
        r'$\frac{{\langle N_{h}^{trans}\rangle}}{{N_h}}$',
    ...
    'nBindModeDiff-norm-rel':
        r'$({\theta_{bridge}}-{\theta_{dangle}})/{\theta}$',
    'nBridgeModeDiff-norm-rel':
        r'$(\theta_{trans}-\theta_{cis})/\theta_{bridge}$',
    'rcut_binding': r'$r_{{thres}}/a_m$',
    'cis_threshold': r'$\Delta n_{{thres}}/\langle l\rangle$',
    'binding_probability_rcut': r'$\theta$',
    'binding_style': 'Binding mode',
    'binding_style-hue': 'State',
    'bridging_probability_rcut': r'$\theta$',
    'bridging_probability_nhns_norm':
        r'$\theta_i/\theta_{bridge}$',
    'bridging_style': 'Bridging mode',
    'eps_hc': r'$\varepsilon_{hc}/\varepsilon$',
    'eps_hc-simple': r'$\varepsilon_{hc}$',
    'bondsHistHnsCore-bin_center': r'$x_d$',
    'bondsHistHnsCore-bin_center-average': r'$\langle x_d\rangle$',
    'bondsHistHnsCore-norm': r'$p$',
    'bondsHistHnsCore-norm-full_name': r'$p(x_d)$',
    'bondsHistHnsCore-norm-full_name-cdf': r'$\mathcal{P}(x_d)$',
    'bondsHistDirDepHnsCore-bin_center': r'$x_d$',
    'bondsHistDirDepHnsCore-bin_center-average': r'$\langle x_d\rangle$',
    'bondsHistDirDepHnsCore-norm': r'$p$',
    'bondsHistDirDepHnsCore-norm-full_name': r'$p(x_d)$',
    'bondsHistDirDepHnsCore-norm-full_name-cdf': r'$\mathcal{P}(x_d)$',
    'clustersHistHnsCore-bin_center': r'$x_c$',
    'clustersHistHnsCore-bin_center-average': r'$\langle x_c\rangle$',
    'clustersHistHnsCore-norm': r'$p$',
    'clustersHistHnsCore-norm-full_name': r'$p(x_c)$',
    'clustersHistHnsCore-norm-full_name-cdf': r'$\mathcal{P}(x_c)$',
    'clustersHistDirDepHnsCore-bin_center': r'$x_c$',
    'clustersHistDirDepHnsCore-bin_center-average': r'$\langle x_c\rangle$',
    'clustersHistDirDepHnsCore-norm': r'$p$',
    'clustersHistDirDepHnsCore-norm-full_name': r'$p(x_c)$',
    'clustersHistDirDepHnsCore-norm-full_name-cdf': r'$\mathcal{P}(x_c)$',
    'bondsHistDangleHnsCore-bin_center': r'$x_d$',
    'bondsHistDangleHnsCore-bin_center-average': r'$\langle x_d\rangle$',
    'bondsHistDangleHnsCore-norm': r'$p$',
    'bondsHistDangleHnsCore-norm-full_name': r'$p(x_d)$',
    'bondsHistDangleHnsCore-norm-full_name-cdf': r'$\mathcal{P}(x_d)$',
    'clustersHistDangleHnsCore-bin_center': r'$x_c$',
    'clustersHistDangleHnsCore-bin_center-average': r'$\langle x_c\rangle$',
    'clustersHistDangleHnsCore-norm': r'$p$',
    'clustersHistDangleHnsCore-norm-full_name': r'$p(x_c)$',
    'clustersHistDangleHnsCore-norm-full_name-cdf': r'$\mathcal{P}(x_c)$',
    'bondsHistBridgeHnsCore-bin_center': r'$x_d$',
    'bondsHistBridgeHnsCore-bin_center-average': r'$\langle x_d\rangle$',
    'bondsHistBridgeHnsCore-norm': r'$p$',
    'bondsHistBridgeHnsCore-norm-full_name': r'$p(x_d)$',
    'bondsHistBridgeHnsCore-norm-full_name-cdf': r'$\mathcal{P}(x_d)$',
    'clustersHistBridgeHnsCore-bin_center': r'$x_c$',
    'clustersHistBridgeHnsCore-bin_center-average': r'$\langle x_c\rangle$',
    'clustersHistBridgeHnsCore-norm': r'$p$',
    'clustersHistBridgeHnsCore-norm-full_name': r'$p(x_c)$',
    'clustersHistBridgeHnsCore-norm-full_name-cdf': r'$\mathcal{P}(x_c)$',
}
