...
(cd ${file} && python probe-all_trj_segments.py > ${file}-python_out-probe-all_trj_segments.txt)
}
...
parallel --will-cite --ungroup  --env _ exe {}-gnuparallel_out-probe-all_trj_segments.txt ::: N*/
