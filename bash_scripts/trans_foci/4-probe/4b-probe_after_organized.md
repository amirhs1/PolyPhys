...
8. After the rum finsihed, check slurm file and change its name to **N_D_ac_phic_-probe-slurm_report-probe_all_in_one.out**, **N_D_ac_phic_-probe-slurm_report-probe_all_trj_segments.out**, or **N_D_ac_phic_-probe-slurm_report-probe_all_bug_segments.out**.
