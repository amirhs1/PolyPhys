...
(cd ${file} && python extraction_segments_hists_mon.py > ${file}-gnuarallel_out-segments_hists_mon.txt)
#echo (cd ${file} && python extraction_all_run.py) this for testing.
}
...
parallel --will-cite --ungroup  --env _ exe {}-gnuparallel-segments_hists_mon.txt ::: N*/
