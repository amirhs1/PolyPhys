...
(cd "${file}" && python probe-sum_rule_hetero_ring_bug_cub-bug_wholes.py)
}
...
parallel --will-cite --ungroup  --env _ exe {}-gnuparallel_out-probe-sum_rule_hetero_ring_bug_cub-bug_wholes.txt ::: al*ring/
