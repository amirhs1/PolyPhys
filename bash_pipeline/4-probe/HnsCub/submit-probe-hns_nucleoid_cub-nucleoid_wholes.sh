...
(cd "${file}" && python probe-hns_nucleoid_cub-nucleoid_wholes.py > "${file}"-probe-hns_nucleoid_cub-nucleoid_wholes.txt)
}
...
parallel --will-cite --ungroup  --env _ exe {}-gnuparallel_out-probe-hns_nucleoid_cub-nucleoid_wholes.txt ::: N*/
