...
(cd "${file}" && python probe-hns_cub-all_in_one-nucleoid_wholes.py > "${file}"-probe-hns_cub-all_in_one-nucleoid_wholes.txt)
}
...
parallel --will-cite --ungroup  --env _ exe {}-gnuparallel_out-probe-hns_cub-all_in_one-nucleoid_wholes.txt ::: N*ring/
