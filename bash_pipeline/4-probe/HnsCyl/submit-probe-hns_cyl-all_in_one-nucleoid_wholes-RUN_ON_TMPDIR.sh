...
python probe-hns_cyl-all_in_one-nucleoid_wholes.py > "${SLURM_TMPDIR}/${file}"-probe-hns_cyl-all_in_one-nucleoid_wholes.txt
...
parallel --will-cite --ungroup  --env _ exe {}-gnuparallel_out-probe-hns_cyl-all_in_one-nucleoid_wholes.txt ::: N*ring/
