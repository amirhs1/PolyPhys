...
(cd "${file}" && python probe-sum_rule_hetero_linear_cub-all_in_one-bug_wholes.py)
}
...
parallel --will-cite --ungroup  --env _ exe {}-gnuparallel_out-probe-sum_rule_hetero_linear_cub-all_in_one-bug_wholes.txt ::: al*linear/
