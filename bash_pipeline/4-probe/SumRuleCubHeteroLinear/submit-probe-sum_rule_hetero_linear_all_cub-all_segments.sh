...
(cd "${file}" && python probe-sum_rule_hetero_linear_all_cub-all_segments.py)
}
...
parallel --will-cite --ungroup  --env _ exe {}-gnuparallel_out-probe-sum_rule_hetero_linear_all_cub-all_segments.txt ::: al*linear/
