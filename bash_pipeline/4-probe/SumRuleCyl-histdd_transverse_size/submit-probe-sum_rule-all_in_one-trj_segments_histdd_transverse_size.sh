...
(cd "${file}" && python probe-sum_rule-all_in_one-trj_segments_histdd_transverse_size.py > "${file}"-probe-sum_rule-all_in_one-trj_segments_histdd_transverse_size.txt)
}
...
parallel --will-cite --ungroup  --env _ exe {}-gnuparallel_out-probe-sum_rule-all_in_one-trj_segments_histdd_transverse_size.txt ::: N*[1-8]/
