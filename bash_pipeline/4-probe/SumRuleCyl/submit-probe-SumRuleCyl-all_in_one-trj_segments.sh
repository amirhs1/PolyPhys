...
(cd "${file}" && python probe-SumRuleCyl-all_in_one-trj_segments.py > "${file}"-probe-SumRuleCyl-all_in_one-trj_segments.txt)
}
...
parallel --will-cite --ungroup  --env _ exe {}-gnuparallel_out-probe-SumRuleCyl-all_in_one-trj_segments.txt ::: N*[1-8]/
