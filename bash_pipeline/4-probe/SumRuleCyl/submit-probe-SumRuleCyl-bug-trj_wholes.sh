...
(cd "${file}" && python probe-SumRuleCyl-bug-trj_wholes.py > "${file}"-probe-SumRuleCyl-bug-trj_wholes.txt)
}
...
parallel --will-cite --ungroup  --env _ exe {}-gnuparallel_out-probe-SumRuleCyl-bug-trj_wholes.txt ::: N*[1-8]/
