...
(cd "${file}" && python probe-sum_rule_all-trj_segments.py > "${file}"-probe-sum_rule_all-trj_segments.txt)
}
...
parallel --will-cite --ungroup  --env _ exe {}-gnuparallel_out-probe-sum_rule_all-trj_segments.txt ::: N*/
