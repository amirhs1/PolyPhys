...
for tar_file in N*ens[1-8]/; do # SumRuleCyl
#for tar_file in N*ring/; do # HnsCub HnsCyl
#for tar_file in al*ring/; do # TransFociCub, SumRuleCubHeteroRing
#for tar_file in al*linear/; do # TransFociCub, SumRuleCubHeteroLinear
#for tar_file in eps*/; do # TransFociCyl
