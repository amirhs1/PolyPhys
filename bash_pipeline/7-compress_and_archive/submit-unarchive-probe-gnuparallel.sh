...
# SumRuleCyl:
#parallel --will-cite --ungroup  --env _ exe ::: N*ens[1-8]-probe.tar.gz 
# HnsCub, HnsCyl:
#parallel --will-cite --ungroup  --env _ exe ::: N*ring-probe.tar.gz
# TransFociCub, TransFociCyl, SumRuleCubHeteroRing, SumRuleCubHeteroLinear:
parallel --will-cite --ungroup  --env _ exe ::: ns*-probe.tar.gz
