...
(cd "${file}" && python probe-trans_foci_all-trj_segments_histdd_transverse_size.py > "${file}"-probe-trans_foci_all-trj_segments_histdd_transverse_size.txt)
}
...
parallel --will-cite --ungroup  --env _ exe {}-gnuparallel_out-probe-trans_foci_all-trj_segments_histdd_transverse_size.txt ::: eps*/
