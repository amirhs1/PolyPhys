...
# generated in MDAanalysis. I use a harmonic potential for the chain and
# minimize the chain in the presenc of crowder, but simulations crash due to
# missed atom and fene bond too long. I cannot use this strategy.
