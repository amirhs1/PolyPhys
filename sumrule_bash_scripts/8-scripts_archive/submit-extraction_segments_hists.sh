...
(cd ${file} && python extraction_segments_hists.py > ${file}-gnuarallel_out-segments_hists.txt)
...
parallel --will-cite --ungroup  --env _ exe {}-gnuparallel_out-segments_hists.txt ::: N*/
